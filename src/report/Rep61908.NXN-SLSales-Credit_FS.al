report 61908 "NXN-SL Sales-CreditFS"
{
    // <changelog>
    ...
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = './Rep61908.NXN-SLSales-Credit_FS.rdl';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            RequestFilterHeading = 'Posted Sales Credit';
            ...
            column(Header_Amount_Excl_GST; "Sales Cr.Memo Header".Amount)
            {
            }
            column(Header_Amount_Incl_GST; "Sales Cr.Memo Header"."Amount Including VAT")
            {
            }
            column(Foreign_Currency; "Sales Cr.Memo Header"."Currency Code")
            {
            }
            ...
            column(Sales_Due_Date; Format("Sales Cr.Memo Header"."Due Date", 0, '<Day> <Month text,3> <Year4>'))
            {
            }
            column(Sales_Posting_Date; Format("Sales Cr.Memo Header"."Posting Date", 0, '<Day> <Month text,3> <Year4>'))
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(PostingDt_SalesInvHeader; "Sales Cr.Memo Header"."Posting Date")
                    {
                    }
                    ...
                    column(DueDate_SalesInvHeader; "Sales Cr.Memo Header"."Due Date")
                    {
                    }
                    ...
                    column(DocumentDate04_SalesInvHeader; "Sales Cr.Memo Header"."Document Date")
                    {
                    }
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        column(LineDiscAmount; "Sales Cr.Memo Line"."Line Discount Amount")
                        {
                        }
                        column(UoM; "Sales Cr.Memo Line"."Unit of Measure Code")
                        {
                        }
                        ...
                        column(SalesLineType_SalesInvLine; Format("Sales Cr.Memo Line".Type))
                        {
                        }
                        ...
                        column(GST_Percent; "Sales Cr.Memo Line"."VAT %")
                        {
                        }
                        column(VATIdentifier_SalesInvLineCaption; FieldCaption("VAT Identifier"))
                        {
                        }
                        // column(WarehouseClassCode; FieldCaption("Sales Cr.Memo Line"."Warehouse Class Code-NXN"))
                        // {
                        // }
                        // column(WarehouseClassSortOrder; FieldCaption("Sales Cr.Memo Line"."Warehouse Class Sort Order-NXN"))
                        // {
                        // }
            ...
            begin
                ...
                //FormatAddr.SalesInvBillTo(CustAddr, "Sales Cr.Memo Header");
                ...
                //FormatAddr.SalesInvShipTo(ShipToAddr, CustAddr, "Sales Cr.Memo Header");
                //FormatAddr.SalesCrAddr, CustAddr, "Sales Cr.Memo Header");
                ...
                SalesCrMemoLine.SetRange("VAT Prod. Posting Group", GLSetup."NXN WET Product Posting Group");
    ...
    begin
        ...
        //CompanyInfo1.CalcFields("NXN Wine Picture");
    ...
    var
        ...
        InvoiceNoCaptionLbl: Label 'Credit Memo No.';
    ...
    procedure GenerateBufferFromShipment(SalesInvoiceLine: Record "Sales Cr.Memo Line")
    var
    ...
    // begin
    //     //MESSAGE("Sales Cr.Memo Header"."Bill-to Customer No.");
    //     InvoicePoint := 0;
    ...
    //     //RebateCalcEntryDetails.SETRANGE("Document No.","Sales Cr.Memo Header"."No.")
    //     RebateCalcEntryDetails.SetRange("Entity Reference Type", RebateCalcEntryDetails."Entity Reference Type"::Customer);
    //     RebateCalcEntryDetails.SetRange("Entity Reference Code", "Sales Cr.Memo Header"."Bill-to Customer No.");
    ...
    //             if RebateCalcEntryDetails."Document No." = "Sales Cr.Memo Header"."No." then
